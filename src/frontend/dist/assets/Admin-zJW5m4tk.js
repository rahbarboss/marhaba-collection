import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, w as React, x as clsx, k as cn, y as reactDomExports, z as ReactDOM, X, R as React2, a as useNavigate, u as useData, q as useBackendActor, m as sampleProducts, A as sampleBanners, g as ShoppingBag, E as ExternalBlob, f as useNotifications } from "./index-DlPS0ULj.js";
...
import { A as ArrowLeft } from "./arrow-left-CV-aMifi.js";
import { L as LogOut } from "./log-out-Dn0wCqud.js";
import { P as Package } from "./package-DnFbWeYk.js";
import { M as MapPin } from "./map-pin-UjxhfJQk.js";
import { Z as Zap } from "./zap-HakWPSfn.js";
import { S as Star } from "./star-5Y0DlRpL.js";
...
function Admin() {
  ...
  const [selectedOrderId, setSelectedOrderId] = reactExports.useState(
    ((_a = INITIAL_ORDERS[0]) == null ? void 0 : _a.id) ?? ""
  );
  const goToTab = (next) => {
  ...
  const saveBanner = async (b) => {
    ...
    try {
      ...
      ue.error(isEdit ? "Failed to update banner" : "Failed to add banner");
    }
  };
