const sampleProducts = [
  // Electronics
  {
    ...
    description: "The most powerful iPhone ever. Titanium design, A17 Pro chip, and revolutionary camera system with 5x optical zoom.",
    category: "Electronics",
    priceInPaise: 1349e4,
    originalPriceInPaise: 1499e4,
    images: [
    ...
    isFeatured: true,
    isFlashDeal: true,
    flashDealEndsAt: Date.now() + 3 * 36e5,
    discount: 10
  },
  {
    id: "prod-002",
    name: "AirPods Pro 2nd Gen",
    description: "Active Noise Cancellation with Transparency mode. USB-C charging case with MagSafe compatibility.",
    category: "Electronics",
    priceInPaise: 249e4,
    originalPriceInPaise: 269e4,
    images: [
  ...
  },
  {
    ...
    description: "Quantum Matrix Technology with Neural Quantum Processor 8K for breathtaking picture quality.",
    category: "Electronics",
    priceInPaise: 1799e4,
    originalPriceInPaise: 2299e4,
    images: [
    ...
    discount: 22,
    isFlashDeal: true,
    flashDealEndsAt: Date.now() + 5 * 36e5
  },
  // Fashion
  {
    id: "prod-004",
    name: "Luxe Leather Bomber Jacket",
    description: "Premium full-grain leather bomber jacket with quilted satin lining. Timeless design, modern fit.",
    category: "Fashion",
  ...
  },
  {
    ...
    description: "Handcrafted pure silk Anarkali with intricate zari embroidery. Perfect for festive and wedding occasions.",
    category: "Fashion",
  ...
  },
  {
    ...
    description: "The iconic silhouette reborn. Premium leather upper with Air-Sole cushioning for all-day comfort.",
    category: "Fashion",
  ...
  // Home
  {
    ...
    description: "Minimalist designer pendant lamp with smart dimming. Compatible with Alexa and Google Home.",
    category: "Home",
    priceInPaise: 849900,
  ...
  },
  {
    ...
    description: "Professional-grade espresso machine with integrated grinder. Brew café-quality coffee at home.",
    category: "Home",
  ...
  // Beauty
  {
    ...
    description: "An oriental woody fragrance for men. Warm, sensual, and deeply sophisticated.",
    category: "Beauty",
    priceInPaise: 195e4,
    originalPriceInPaise: 225e4,
    images: [
    ...
    discount: 13,
    isFlashDeal: true,
    flashDealEndsAt: Date.now() + 2 * 36e5
  },
  {
    id: "prod-010",
    name: "La Mer Crème de la Mer",
    description: "The legendary moisturizing cream with Miracle Broth™. Transforms skin, visibly reducing lines.",
    category: "Beauty",
    priceInPaise: 325e4,
    originalPriceInPaise: 35e5,
    images: [
  ...
  // Sports
  {
    ...
    description: "Replace 15 sets of weights. Quick-change dial selects from 5 to 52.5 lbs in 2.5 lb increments.",
    category: "Sports",
  ...
  },
  {
    ...
    description: "6mm thick natural rubber mat with alignment lines. Premium moisture-wicking microfiber surface.",
    category: "Sports",
    priceInPaise: 499900,
...
const sampleCoupons = [
  {
    ...
    maxDiscountInPaise: 5e4,
    validUntil: Date.now() + 30 * 864e5
  },
  {
    code: "WELCOME200",
  ...
  },
  {
    ...
    maxDiscountInPaise: 1e5,
    validUntil: Date.now() + 1 * 864e5
  },
  {
    code: "LUXURY15",
    ...
    discountValue: 15,
    minOrderInPaise: 5e5,
    maxDiscountInPaise: 2e5,
    validUntil: Date.now() + 14 * 864e5
  }
];
...
function applyCoupon(code, subtotalInPaise) {
  ...
  let discount = coupon.discountType === "percentage" ? Math.round(subtotalInPaise * coupon.discountValue / 100) : coupon.discountValue;
...
function getBestCoupon(subtotalInPaise) {
  let bestCoupon = null;
  let bestDiscount = 0;
