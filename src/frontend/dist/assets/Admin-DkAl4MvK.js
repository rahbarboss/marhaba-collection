import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, n as React, o as clsx, i as cn, p as reactDomExports, q as ReactDOM, X, R as React2, a as useNavigate, u as useData, k as useBackendActor, g as ShoppingBag, E as ExternalBlob, f as useNotifications } from "./index-dBmmwt_c.js";
import { C as Check, S as Shield } from "./shield-BCVB9UvK.js";
...
import { L as LogOut } from "./log-out-M7P2sD6N.js";
...
const DEFAULT_COORDS = [26.0958, 87.9399];
...
function toAdminOrder(o) {
  const date = new Date(Number(o.createdAt) / 1e6).toISOString().slice(0, 10);
  return {
...
function ProductFormModal({
  ...
  const [form, setForm] = reactExports.useState({
    ...
    category: (product == null ? void 0 : product.category) ?? "Electronics",
    priceInPaise: product ? String(product.priceInPaise / 100) : "",
    originalPriceInPaise: (product == null ? void 0 : product.originalPriceInPaise) ? String(product.originalPriceInPaise / 100) : "",
    stock: product ? String(product.stock) : "",
    tags: (product == null ? void 0 : product.tags.join(", ")) ?? "",
    isFlashDeal: (product == null ? void 0 : product.isFlashDeal) ?? false,
    isFeatured: (product == null ? void 0 : product.isFeatured) ?? false,
    images: (product == null ? void 0 : product.images) ?? [],
    specifications: (product == null ? void 0 : product.specifications) ?? [{ label: "", value: "" }]
  });
  const set = (k, v) => setForm((prev) => ({ ...prev, [k]: v }));
  const addSpec = () => set("specifications", [...form.specifications, { label: "", value: "" }]);
  const removeSpec = (i) => set(
    "specifications",
    form.specifications.filter((_, idx) => idx !== i)
  );
  const updateSpec = (i, field, val) => {
    const updated = form.specifications.map(
      (s, idx) => idx === i ? { ...s, [field]: val } : s
    );
  ...
  const handleFiles = (e) => {
    up.upload(
      e.target.files,
      (urls) => set("images", [...form.images, ...urls])
    );
  };
  const handleSave = async () => {
    if (!form.name || !form.priceInPaise || !form.stock) {
      ue.error("Name, price and stock are required");
      return;
    }
    const origPrice = form.originalPriceInPaise ? Math.round(Number.parseFloat(form.originalPriceInPaise) * 100) : void 0;
    const price = Math.round(Number.parseFloat(form.priceInPaise) * 100);
    const saved = {
      id: (product == null ? void 0 : product.id) ?? `prod-${Date.now()}`,
      name: form.name,
      ...
      rating: (product == null ? void 0 : product.rating) ?? 4.5,
      reviewCount: (product == null ? void 0 : product.reviewCount) ?? 0,
      reviews: (product == null ? void 0 : product.reviews) ?? [],
      discount: origPrice && origPrice > price ? Math.round((origPrice - price) / origPrice * 100) : void 0
    };
    setSaving(true);
    try {
      await onSave(saved);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open, onOpenChange: (v) => !v && onClose(), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "max-w-2xl max-h-[90vh] overflow-y-auto border-border bg-card", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 py-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-muted-foreground text-xs mb-1 block", children: "Product Name *" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-muted-foreground text-xs mb-1 block", children: "Description" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Textarea,
            {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-muted-foreground text-xs mb-1 block", children: "Stock *" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-muted-foreground text-xs mb-1 block", children: "Price (₹) *" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-muted-foreground text-xs mb-1 block", children: "Original Price (₹)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-muted-foreground text-xs mb-1 block", children: "Tags (comma-separated)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { className: "text-sm flex items-center gap-1", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-muted-foreground text-xs mb-2 block", children: "Product Images" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            type: "button",
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Upload, { className: "h-6 w-6 mx-auto mb-1 text-muted-foreground" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Click to upload images" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
                  ref: fileRef,
        ...
        up.uploading && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Progress, { value: up.progress, className: "h-1.5" })
        ] }),
        form.images.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2 mt-3 flex-wrap", children: form.images.map((img, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "h-2.5 w-2.5 text-white" })
                }
              )
            ]
          },
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-muted-foreground text-xs", children: "Specifications" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: form.specifications.map((spec, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
...
function BannerFormModal({ banner, open, onClose, onSave }) {
  const isEdit = !!banner;
  const up = useUpload();
  const fileRef = reactExports.useRef(null);
  const [saving, setSaving] = reactExports.useState(false);
  const [form, setForm] = reactExports.useState({
    ...
    imageUrl: (banner == null ? void 0 : banner.imageUrl) ?? "",
    ctaLabel: (banner == null ? void 0 : banner.ctaLabel) ?? "Shop Now",
    ctaLink: (banner == null ? void 0 : banner.ctaLink) ?? "",
    active: true,
    order: 1
  });
  const set = (k, v) => setForm((prev) => ({ ...prev, [k]: v }));
  ...
  const handleSave = async () => {
    if (!form.title || !form.imageUrl) {
      ue.error("Title and image are required");
      return;
    }
    setSaving(true);
    try {
      await onSave({
        id: (banner == null ? void 0 : banner.id) ?? `banner-${Date.now()}`,
        title: form.title,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open, onOpenChange: (v) => !v && onClose(), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "max-w-lg border-border bg-card", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogTitle, { className: "text-foreground flex items-center gap-2", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 py-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs text-muted-foreground mb-1 block", children: "Subtitle" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs text-muted-foreground mb-1 block", children: "CTA Label" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
              value: form.ctaLabel,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs text-muted-foreground mb-1 block", children: "Link URL" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
              value: form.ctaLink,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs text-muted-foreground mb-1 block", children: "Position Order" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
              type: "number",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs text-muted-foreground mb-2 block", children: "Banner Image *" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            type: "button",
...
function OrderDetailModal({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open, onOpenChange: (v) => !v && onClose(), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "max-w-sm border-border bg-card", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 text-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-2 text-xs", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold", children: order.customer })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: "Phone" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold", children: order.phone })
        ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              ...
              children: formatINR(order.totalInPaise)
            }
          )
        ] })
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Button,
        {
          ...
          onClick: onConfirm,
          children: [
            loading ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "h-4 w-4 mr-1 animate-spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Trash2, { className: "h-4 w-4 mr-1" }),
            "Delete"
          ]
        }
      )
...
function AdminLogin({ onLogin }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-background flex items-center justify-center p-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-sm", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          style: {
            background: "linear-gradient(135deg, oklch(0.675 0.25 178), oklch(0.72 0.26 90))"
          },
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(Shield, { className: "h-8 w-8 text-background" })
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold text-foreground font-display", children: "Marhaba Collection Admin" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mt-1", children: "Sign in to manage your store" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-border p-6 space-y-4 bg-card", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs text-muted-foreground mb-1.5 block", children: "Password" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button,
        {
          ...
          onClick: handleLogin,
          children: "Sign In to Admin Panel"
        }
      )
    ] })
  ] }) });
...
function Admin() {
  ...
  const [products, setProducts] = reactExports.useState(ctxProducts);
  const [banners, setBanners] = reactExports.useState(ctxBanners);
  reactExports.useEffect(() => {
  ...
  const [productModal, setProductModal] = reactExports.useState({ open: false });
  const [deleteDialog, setDeleteDialog] = reactExports.useState({ open: false, type: "product", id: "", label: "", loading: false });
  const [bannerModal, setBannerModal] = reactExports.useState({ open: false });
  const [orders, setOrders] = reactExports.useState([]);
  const [ordersLoading, setOrdersLoading] = reactExports.useState(false);
  const [orderDetail, setOrderDetail] = reactExports.useState({ open: false, order: null });
  const [selectedOrderId, setSelectedOrderId] = reactExports.useState("");
  const goToTab = (next) => {
  ...
  if (!isAuthed) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(AdminLogin, { onLogin: () => setIsAuthed(true) });
  }
  const saveProduct = async (p) => {
    ...
    try {
      ...
      if (isEdit) {
        ...
        if (!updated) {
          ue.error("Product not found in backend");
          return;
        }
      } else {
      ...
      await refetch();
      ue.success(isEdit ? "Product updated!" : "Product saved!");
    } catch (err) {
  ...
  const saveBanner = async (b) => {
    ...
    try {
      const input = {
        ...
        linkUrl: b.ctaLink,
        order: BigInt(
          isEdit ? banners.findIndex((x) => x.id === b.id) + 1 : banners.length + 1
        ),
        isActive: true
      };
      if (!actor) {
      ...
      if (isEdit) {
        ...
        if (!updated) {
          ue.error("Banner not found in backend");
          return;
        }
      } else {
      ...
      await new Promise((resolve) => setTimeout(resolve, 500));
      await refetch();
      ue.success(isEdit ? "Banner updated!" : "Banner saved!");
    } catch (err) {
      console.error("[Admin] saveBanner error:", err);
      ue.error(isEdit ? "Failed to update banner" : "Failed to save banner");
    }
  };
  ...
  const updateOrderStatus = async (id, status) => {
    ...
    try {
      if (actor && (order == null ? void 0 : order._backendId) !== void 0) {
      ...
      setOrders(
        (prev) => prev.map(
          (o) => o.id === id ? { ...o, status: (order == null ? void 0 : order.status) ?? status } : o
        )
      );
      ue.error("Failed to update order status");
    }
  };
  const totalRevenue = orders.filter((o) => o.status !== "cancelled").reduce((s, o) => s + o.totalInPaise, 0);
  const selectedOrder = orders.find((o) => o.id === selectedOrderId) ?? orders[0];
  const mapCoords = selectedOrder ? getCityCoords(selectedOrder.city) : DEFAULT_COORDS;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background text-foreground", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sticky top-0 z-40 border-b border-border bg-card/95 backdrop-blur-sm", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(Shield, { className: "h-4 w-4 text-background" })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-sm font-bold font-display", children: "Marhaba Collection Admin" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground", children: "Control Panel" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex overflow-x-auto border-t border-border", children: TABS.map((t) => {
        const Icon2 = t.icon;
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            className: `flex items-center gap-1.5 px-4 py-2.5 text-xs font-medium whitespace-nowrap border-b-2 transition-colors ${tab === t.id ? "border-primary text-primary" : "border-transparent text-muted-foreground hover:text-foreground"}`,
            children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 max-w-screen-xl mx-auto", children: [
      tab === "dashboard" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "admin.dashboard.section", className: "space-y-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-bold font-display mb-1", children: "Overview" }),
            ...
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between mb-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: `h-5 w-5 ${stat.iconColor}` }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { className: "h-4 w-4 text-emerald-400" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl font-bold text-foreground font-display", children: stat.value }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: stat.label }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-emerald-400 mt-1", children: stat.trend })
              ]
            },
            stat.label
          );
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-semibold mb-3 text-muted-foreground uppercase tracking-wide", children: "Recent Orders" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-xl border border-border bg-card overflow-hidden", children: orders.slice(0, 4).map((o, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: `flex items-center justify-between p-3 ${i < 3 ? "border-b border-border" : ""}`,
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium", children: o.customer }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: o.id })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1", children: formatINR(o.totalInPaise) })
                ] })
              ]
            },
            o.id
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-semibold mb-3 text-muted-foreground uppercase tracking-wide", children: "Quick Actions" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs", children: "Add Product" })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs", children: "Add Banner" })
                ]
              }
            )
          ] })
      ...
      tab === "products" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "admin.products.section", className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-bold font-display", children: "Products" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-xl border border-border bg-card overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollArea, { className: "w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { className: "border-border", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "text-muted-foreground text-xs w-12", children: "IMG" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "text-muted-foreground text-xs", children: "Name" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "text-muted-foreground text-xs", children: "Category" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "text-muted-foreground text-xs text-right", children: "Price" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "text-muted-foreground text-xs text-center", children: "Stock" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "text-muted-foreground text-xs text-center", children: "Flash" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "text-muted-foreground text-xs text-center", children: "Trend" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "text-muted-foreground text-xs text-center w-20", children: "Actions" })
          ] }) }),
            ...
            TableRow,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(TableCell, { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium line-clamp-1 max-w-[140px]", children: p.name }),
                  p.stock === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-red-400", children: "Out of stock" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Badge,
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      type: "button",
      ...
      tab === "banners" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "admin.banners.section", className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-bold font-display", children: "Banners" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
              banners.length,
              " active banners"
            ] })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 gap-4", children: banners.map((b, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative h-36", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-r from-background/80 to-transparent flex items-center px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-bold text-foreground", children: b.title }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: b.subtitle }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "span",
                    {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-2 right-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[10px] bg-emerald-500/80 text-white px-1.5 py-0.5 rounded-full flex items-center gap-0.5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "h-2.5 w-2.5" }),
                  "Active"
                ] }) })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-3 py-2 border-t border-border", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
                  "Position #",
                  i + 1
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      ...
                      onClick: () => setBannerModal({ open: true, banner: b }),
                      className: "h-7 w-7 rounded-md flex items-center justify-center hover:bg-primary/20 text-muted-foreground hover:text-primary transition-colors",
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx(Pencil, { className: "h-3.5 w-3.5" })
                    }
                  ),
      ...
      tab === "orders" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "admin.orders.section", className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-bold font-display", children: "Orders" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: ordersLoading ? "Loading..." : `${orders.length} total orders` })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                ordersLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "h-3 w-3 animate-spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Navigation, { className: "h-3 w-3" }),
                "Refresh"
              ]
            }
          )
        ] }),
        ordersLoading ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", children: "Loading orders..." })
            ]
          }
          ...
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(ShoppingBag, { className: "h-10 w-10 mx-auto mb-3 text-muted-foreground/40" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-muted-foreground", children: "No orders yet" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground/60 mt-1", children: "Orders placed by customers will appear here" })
            ]
          }
        ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: orders.map((o, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between mb-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground flex items-center gap-1 mt-0.5", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "h-2.5 w-2.5 text-primary" }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "p",
                    {
                      ...
                      style: { color: "oklch(0.675 0.25 178)" },
                      children: formatINR(o.totalInPaise)
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
                    o.items,
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  Select,
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: Object.keys(statusLabels).map(
                        (s) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: s, className: "text-xs", children: statusLabels[s] }, s)
                      ) })
                    ]
                  }
                ),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "text-sm font-semibold mb-2 flex items-center gap-1.5", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                ...
                children: "Kishanganj Delivery Zone"
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border overflow-hidden", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-muted/30 px-3 py-1.5 text-xs text-muted-foreground border-b border-border flex items-center gap-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Navigation, { className: "h-3 w-3 text-primary" }),
              selectedOrder ? `${selectedOrder.city}, ${selectedOrder.state} — ${mapCoords[0].toFixed(4)}°N, ${mapCoords[1].toFixed(4)}°E` : "Kishanganj, Bihar"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "iframe",
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-medium uppercase tracking-wide", children: "Select order to view on map" }),
            orders.map((o, i) => {
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  className: `w-full text-left rounded-lg border p-2.5 transition-all ${isSelected ? "border-primary/60 bg-primary/10" : "border-border bg-card hover:border-primary/30 hover:bg-muted/20"}`,
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 min-w-0", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                          ...
                          style: {
                            background: isSelected ? "oklch(0.675 0.25 178)" : "oklch(0.675 0.25 178 / 0.2)"
                          },
                          children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                            MapPin,
                            {
                              className: "h-3 w-3",
                              style: {
                                color: isSelected ? "var(--background)" : "oklch(0.675 0.25 178)"
                              }
                            }
                          )
                        }
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold truncate", children: o.customer }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground truncate", children: o.address ?? `${o.city}, ${o.state}` })
                      ] })
                    ] }),
      ...
      tab === "users" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "admin.users.section", className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-bold font-display", children: "Users" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
            SAMPLE_USERS.length,
            " registered users"
          ] })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-xl border border-border bg-card overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollArea, { className: "w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { className: "border-border", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "text-muted-foreground text-xs", children: "#" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "text-muted-foreground text-xs", children: "Name" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "text-muted-foreground text-xs", children: "Phone" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "text-muted-foreground text-xs", children: "Email" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "text-muted-foreground text-xs text-right", children: "Points" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "text-muted-foreground text-xs", children: "Joined" })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: SAMPLE_USERS.map((u, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            TableRow,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium", children: u.name })
                ] }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-sm text-muted-foreground", children: u.phone }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-xs text-muted-foreground", children: u.joined })
              ]
            },
            u.id
          )) })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border bg-card p-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-semibold mb-3", children: "Rewards Summary" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 gap-3 text-center", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl font-bold font-display text-emerald-400", children: SAMPLE_USERS.filter((u) => u.points > 200).length }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Power Users" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl font-bold font-display text-primary", children: SAMPLE_USERS.length }),
